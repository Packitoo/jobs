...
First create the project structure. For this you should use create-react-app.
...
Setup redux, react-redux and redux-thunk. You can use the feature based example https://github.com/ryanlanciaux/react_feature_folder_example

For this setup you should create store / reducer / actions create / actions type.
...
Title and Comment are simple text input and the value of these inputs are stocked in the state of the component check this link to learn how https://reactjs.org/docs/forms.html
...
#### Bonus #1. Inform user of request with Loading
